...
var TypeExtension = /** @class */ (function () {
    ...
    TypeExtension.prototype.toString = function () {
        var queries = this.queries.length > 0
            ? "{\n".concat(this.queries.map(String).join('\n'), "\n}")
            : '';
        ...
        var fieldExtends = this.fieldExtensions.length > 0
            ...
            : '';
        return "extend type ".concat(this.name, " ").concat(keys).concat(fieldExtends).concat(queries);
    };
